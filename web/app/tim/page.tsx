    ...
    <main>
      ...
      <section className="border-t border-border bg-bg-alt">
        <div className="mx-auto max-w-[1280px] px-6 py-14 md:px-12 md:py-20">
          ...
          <RevealGroup className="grid grid-cols-1 border-t border-border-soft md:grid-cols-3">
            {STEPS.map((step, i) => (
              <RevealItem
                key={i}
                className="border-b border-border-soft px-0 py-10 md:px-8 md:first:pl-0 md:last:pr-0"
              >
      ...
      <section className="border-t border-border">
        <div className="mx-auto max-w-[1280px] px-6 py-14 md:px-12 md:py-20">
          ...
          <RevealGroup className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
            {members.map((member) => {
